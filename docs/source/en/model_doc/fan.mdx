...
The FAN model was proposed in [Understanding The Robustness in Vision Transformers](https://arxiv.org/abs/2204.12451)  by Daquan Zhou, Zhiding Yu, Enze Xie,
...
they've achieved great performance in many visual tasks. These self-attention models were outperforming ConvNets on corruption robustness as per ([Bai et al., 2021](https://arxiv.org/abs/2111.05464); [Xie et al., 2021](https://arxiv.org/abs/2105.15203); [Paul & Chen, 2022](https://arxiv.org/abs/2105.07581); [Naseer et al., 2021](https://arxiv.org/abs/2105.10497)),
which was attributed to their designs, this was later challenged by the introduction of [ConvNeXt](https://arxiv.org/abs/2201.03545) where a model built from convolution modules without self-attention competed favorably against ViT in generalization and robustness.
...
demonstrate state-of-the-art accuracy and robustness in two downstream tasks: semantic segmentation and object detection. Code is available at
